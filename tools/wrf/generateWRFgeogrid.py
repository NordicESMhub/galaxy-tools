...
def main():
	...
	parser.add_option("-g", "--geogrid", dest="geogrid_info",
                  help="Geogrid file containing geogrid information", metavar="geogrid_info")

	parser.add_option("-o", "--output", dest="geogrid_namelist",
                  help="geogrid_namelist file used by WPS (part of namelist.wps)", metavar="geogrid_namelist")
